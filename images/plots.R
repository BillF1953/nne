...
hist(slr$Estimate, xlab="Point Estimate Theta=33.4", main="Coverage Study NSLR2")
...
hist(nslr2$Estimate, xlab="Point Estimate Theta=33.4", main="Coverage Study NSLR2")
